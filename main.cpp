...
void TestKonstruktora(){
    Stek<int> s;
    std::cout <<"\nTest konstruktora: \n";
    std::cout << "Ocekivani broj elemenata je 0, a dobijeni "<<s.brojElemenata()<<std::endl;
    std::cout << "Da li je test uspjesan? ";
    if(s.brojElemenata()==0) std::cout << "DA\n";
    else std::cout << "NE\n";
}
...
void TestMetodeStavi1(){
    ...
    s.stavi(4);
    std::cout <<"\nTest metode stavi: \n";
    std::cout << "Ocekivani broj elemenata je 1, a dobijeni "<<s.brojElemenata()<<std::endl;
    std::cout << "Da li je test uspjesan? ";
    if(s.brojElemenata()==1) std::cout << "DA\n";
    else std::cout << "NE\n";
}
...
void TestMetodeStavi2(){
    ...
    s.stavi(6);
    std::cout <<"\nTest metode stavi: \n";
    std::cout << "Ocekivani broj elemenata je 3, a dobijeni "<<s.brojElemenata()<<std::endl;
    std::cout << "Da li je test uspjesan? ";
    if(s.brojElemenata()==3) std::cout << "DA\n";
    else std::cout << "NE\n";
}
...
void TestMetodeVrh(){
    ...
    s.stavi(6);
    std::cout <<"\nTest metode vrh: \n";
    std::cout << "Ocekivani rezultat je 6, a dobijeni je: "<<s.vrh()<<std::endl;
    std::cout << "Da li je test uspjesan? ";
    if(s.vrh()==6) std::cout << "DA\n";
    else std::cout << "NE\n";
}
...
void TestMetodeSkini(){
    ...
    s.skini();
    std::cout <<"\nTest metode skini: \n";
    std::cout << "Ocekivani rezultat je 5, a dobijeni je: "<<s.vrh()<<std::endl;
    std::cout << "Ocekivani broj elemenata je 2, a dobijeni je: "<<s.brojElemenata()<<std::endl;
    std::cout << "Da li je test uspjesan? ";
    if(s.vrh()==5 && s.brojElemenata()==2) std::cout << "DA\n";
    else std::cout << "NE\n";
}
